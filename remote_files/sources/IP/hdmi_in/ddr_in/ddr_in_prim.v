...
// Netlist written on Tue Jan 12 21:20:12 2021
//
// Verilog Description of module ddr_in
//

module ddr_in (clkin, reset, sclk, datain, q) /* synthesis NGD_DRC_MASK=1, syn_module_defined=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(8[8:14])
    input clkin /* synthesis black_box_pad_pin=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(9[16:21])
    input reset;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(10[16:21])
    output sclk;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(12[17:21])
    input [15:0]datain;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(11[23:29])
    output [31:0]q;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(13[24:25])
    
    wire sclk /* synthesis is_clock=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(12[17:21])
    ...
    IB Inst1_IB15 (.I(datain[15]), .O(buf_dataini15)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(181[8:54])
    IB Inst1_IB14 (.I(datain[14]), .O(buf_dataini14)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(184[8:54])
    IB Inst1_IB13 (.I(datain[13]), .O(buf_dataini13)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(187[8:54])
    IB Inst1_IB12 (.I(datain[12]), .O(buf_dataini12)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(190[8:54])
    IB Inst1_IB11 (.I(datain[11]), .O(buf_dataini11)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(193[8:54])
    IB Inst1_IB10 (.I(datain[10]), .O(buf_dataini10)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(196[8:54])
    IB Inst1_IB9 (.I(datain[9]), .O(buf_dataini9)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(199[8:51])
    IB Inst1_IB8 (.I(datain[8]), .O(buf_dataini8)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(202[8:51])
    IB Inst1_IB7 (.I(datain[7]), .O(buf_dataini7)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(205[8:51])
    IB Inst1_IB6 (.I(datain[6]), .O(buf_dataini6)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(208[8:51])
    IB Inst1_IB5 (.I(datain[5]), .O(buf_dataini5)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(211[8:51])
    IB Inst1_IB4 (.I(datain[4]), .O(buf_dataini4)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(214[8:51])
    IB Inst1_IB3 (.I(datain[3]), .O(buf_dataini3)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(217[8:51])
    IB Inst1_IB2 (.I(datain[2]), .O(buf_dataini2)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(220[8:51])
    IB Inst1_IB1 (.I(datain[1]), .O(buf_dataini1)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(223[8:51])
    IB Inst1_IB0 (.I(datain[0]), .O(buf_dataini0)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(226[8:51])
    GSR GSR_INST (.GSR(VCC_net));
    VLO i74 (.Z(GND_net));
    IB Inst3_IB (.I(clkin), .O(sclk)) /* synthesis IO_TYPE="LVCMOS18", syn_instantiated=1 */ ;   // f:/cypress_ecp/hdmi_industrial_4k/hdmi_in/ddr_in/ddr_in.v(82[8:43])
