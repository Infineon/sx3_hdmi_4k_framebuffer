...
// Netlist written on Tue Mar 23 13:50:14 2021
//
// Verilog Description of module aud_buffer
//

module aud_buffer (Data, Clock, WrEn, RdEn, Reset, Q, Empty, Full, 
            AlmostFull) /* synthesis NGD_DRC_MASK=1, syn_module_defined=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(8[8:18])
    input [15:0]Data;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(10[23:27])
    input Clock;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(11[16:21])
    input WrEn;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(12[16:20])
    input RdEn;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(13[16:20])
    input Reset;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(14[16:21])
    output [15:0]Q;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(15[24:25])
    output Empty;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(16[17:22])
    output Full;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(17[17:21])
    output AlmostFull;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(18[17:27])
    
    wire Clock /* synthesis is_clock=1, SET_AS_NETWORK=Clock */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(11[16:21])
    ...
    AND2 AND2_t4 (.A(WrEn), .B(invout_2), .Z(wren_i)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(122[10:54])
    AND2 AND2_t3 (.A(RdEn), .B(invout_1), .Z(rden_i)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(126[10:54])
    FD1P3DX FF_25 (.D(ifcount_1), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_1)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(203[13] 204[22])
    defparam FF_25.GSR = "ENABLED";
    FD1P3DX FF_24 (.D(ifcount_2), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_2)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(207[13] 208[22])
    defparam FF_24.GSR = "ENABLED";
    FD1P3DX FF_23 (.D(ifcount_3), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_3)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(211[13] 212[22])
    defparam FF_23.GSR = "ENABLED";
    FD1P3DX FF_22 (.D(ifcount_4), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_4)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(215[13] 216[22])
    defparam FF_22.GSR = "ENABLED";
    FD1P3DX FF_21 (.D(ifcount_5), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_5)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(219[13] 220[22])
    defparam FF_21.GSR = "ENABLED";
    FD1P3DX FF_20 (.D(ifcount_6), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_6)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(223[13] 224[22])
    defparam FF_20.GSR = "ENABLED";
    FD1P3DX FF_19 (.D(ifcount_7), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_7)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(227[13] 228[22])
    defparam FF_19.GSR = "ENABLED";
    FD1S3BX FF_18 (.D(empty_d), .CK(Clock), .PD(Reset), .Q(Empty)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(231[13:69])
    defparam FF_18.GSR = "ENABLED";
    FD1S3DX FF_17 (.D(full_d), .CK(Clock), .CD(Reset), .Q(Full)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(234[13:67])
    defparam FF_17.GSR = "ENABLED";
    FD1P3DX FF_16 (.D(iwcount_0), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_0)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(237[13:85])
    defparam FF_16.GSR = "ENABLED";
    FD1P3DX FF_15 (.D(iwcount_1), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_1)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(240[13:85])
    defparam FF_15.GSR = "ENABLED";
    FD1P3DX FF_14 (.D(iwcount_2), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_2)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(243[13:85])
    defparam FF_14.GSR = "ENABLED";
    FD1P3DX FF_13 (.D(iwcount_3), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_3)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(246[13:85])
    defparam FF_13.GSR = "ENABLED";
    FD1P3DX FF_12 (.D(iwcount_4), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_4)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(249[13:85])
    defparam FF_12.GSR = "ENABLED";
    FD1P3DX FF_11 (.D(iwcount_5), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_5)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(252[13:85])
    defparam FF_11.GSR = "ENABLED";
    FD1P3DX FF_10 (.D(iwcount_6), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_6)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(255[13:85])
    defparam FF_10.GSR = "ENABLED";
    FD1P3DX FF_9 (.D(iwcount_7), .SP(wren_i), .CK(Clock), .CD(Reset), 
            .Q(wcount_7)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(258[13:84])
    defparam FF_9.GSR = "ENABLED";
    FD1P3DX FF_8 (.D(ircount_0), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_0)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(261[13:84])
    defparam FF_8.GSR = "ENABLED";
    FD1P3DX FF_7 (.D(ircount_1), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_1)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(264[13:84])
    defparam FF_7.GSR = "ENABLED";
    FD1P3DX FF_6 (.D(ircount_2), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_2)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(267[13:84])
    defparam FF_6.GSR = "ENABLED";
    FD1P3DX FF_5 (.D(ircount_3), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_3)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(270[13:84])
    defparam FF_5.GSR = "ENABLED";
    FD1P3DX FF_4 (.D(ircount_4), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_4)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(273[13:84])
    defparam FF_4.GSR = "ENABLED";
    FD1P3DX FF_3 (.D(ircount_5), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_5)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(276[13:84])
    defparam FF_3.GSR = "ENABLED";
    FD1P3DX FF_2 (.D(ircount_6), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_6)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(279[13:84])
    defparam FF_2.GSR = "ENABLED";
    FD1P3DX FF_1 (.D(ircount_7), .SP(rden_i), .CK(Clock), .CD(Reset), 
            .Q(rcount_7)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(282[13:84])
    defparam FF_1.GSR = "ENABLED";
    FD1S3DX FF_0 (.D(af_d), .CK(Clock), .CD(Reset), .Q(AlmostFull)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(285[13:68])
    defparam FF_0.GSR = "ENABLED";
    CCU2C bdcnt_bctr_cia (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), 
          .D0(scuba_vhi), .A1(cnt_con), .B1(cnt_con), .C1(scuba_vhi), 
          .D1(scuba_vhi), .COUT(bdcnt_bctr_ci)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(292[11] 294[52])
    ...
    CCU2C bdcnt_bctr_0 (.A0(fcount_0), .B0(cnt_con), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(bdcnt_bctr_ci), .COUT(co0), .S0(ifcount_0), .S1(ifcount_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(300[11] 302[73])
    ...
    CCU2C bdcnt_bctr_1 (.A0(fcount_2), .B0(cnt_con), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0), .COUT(co1), .S0(ifcount_2), .S1(ifcount_3)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(308[11] 310[63])
    ...
    CCU2C bdcnt_bctr_2 (.A0(fcount_4), .B0(cnt_con), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1), .COUT(co2), .S0(ifcount_4), .S1(ifcount_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(316[11] 318[63])
    ...
    CCU2C bdcnt_bctr_3 (.A0(fcount_6), .B0(cnt_con), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2), .S0(ifcount_6), .S1(ifcount_7)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(324[11] 326[63])
    ...
    CCU2C e_cmp_ci_a (.A0(scuba_vhi), .B0(scuba_vhi), .C0(scuba_vhi), 
          ...
          .D1(scuba_vhi), .COUT(cmp_ci)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(332[11] 334[45])
    ...
    CCU2C e_cmp_0 (.A0(rden_i), .B0(fcount_0), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(cmp_ci), .COUT(co0_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(340[11] 342[50])
    ...
    CCU2C e_cmp_1 (.A0(scuba_vlo), .B0(fcount_2), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0_1), .COUT(co1_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(348[11] 350[49])
    ...
    CCU2C e_cmp_2 (.A0(scuba_vlo), .B0(fcount_4), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1_1), .COUT(co2_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(356[11] 358[49])
    ...
    CCU2C e_cmp_3 (.A0(scuba_vlo), .B0(fcount_6), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2_1), .COUT(cmp_le_1_c)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(364[11] 366[54])
    ...
    CCU2C a0 (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(cmp_le_1_c), .S0(cmp_le_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(372[11] 374[57])
    ...
    CCU2C g_cmp_ci_a (.A0(scuba_vhi), .B0(scuba_vhi), .C0(scuba_vhi), 
          .D0(scuba_vhi), .A1(scuba_vhi), .B1(scuba_vhi), .C1(scuba_vhi), 
          .D1(scuba_vhi), .COUT(cmp_ci_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(380[11] 382[47])
    ...
    CCU2C g_cmp_0 (.A0(fcount_0), .B0(wren_i), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(cmp_ci_1), .COUT(co0_2)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(388[11] 390[52])
    ...
    CCU2C g_cmp_1 (.A0(fcount_2), .B0(wren_i), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0_2), .COUT(co1_2)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(396[11] 398[49])
    ...
    CCU2C g_cmp_2 (.A0(fcount_4), .B0(wren_i), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1_2), .COUT(co2_2)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(404[11] 406[49])
    ...
    CCU2C g_cmp_3 (.A0(fcount_6), .B0(wren_i), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2_2), .COUT(cmp_ge_d1_c)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(412[11] 414[55])
    ...
    CCU2C a1 (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          .A1(scuba_vlo), .B1(scuba_vlo), .C1(scuba_vhi), .D1(scuba_vhi), 
          .CIN(cmp_ge_d1_c), .S0(cmp_ge_d1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(420[11] 422[59])
    ...
    CCU2C w_ctr_cia (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .COUT(w_ctr_ci)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(428[11] 430[47])
    ...
    CCU2C w_ctr_0 (.A0(wcount_0), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(w_ctr_ci), .COUT(co0_3), .S0(iwcount_0), .S1(iwcount_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(436[11] 438[70])
    ...
    CCU2C w_ctr_1 (.A0(wcount_2), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0_3), .COUT(co1_3), .S0(iwcount_2), .S1(iwcount_3)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(444[11] 446[67])
    ...
    CCU2C w_ctr_2 (.A0(wcount_4), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1_3), .COUT(co2_3), .S0(iwcount_4), .S1(iwcount_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(452[11] 454[67])
    ...
    CCU2C w_ctr_3 (.A0(wcount_6), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2_3), .S0(iwcount_6), .S1(iwcount_7)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(460[11] 462[67])
    ...
    CCU2C r_ctr_cia (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          .A1(scuba_vhi), .B1(scuba_vhi), .C1(scuba_vhi), .D1(scuba_vhi), 
          .COUT(r_ctr_ci)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(468[11] 470[47])
    ...
    CCU2C r_ctr_0 (.A0(rcount_0), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(r_ctr_ci), .COUT(co0_4), .S0(ircount_0), .S1(ircount_1)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(476[11] 478[70])
    ...
    CCU2C r_ctr_1 (.A0(rcount_2), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0_4), .COUT(co1_4), .S0(ircount_2), .S1(ircount_3)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(484[11] 486[67])
    ...
    CCU2C r_ctr_2 (.A0(rcount_4), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1_4), .COUT(co2_4), .S0(ircount_4), .S1(ircount_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(492[11] 494[67])
    ...
    CCU2C r_ctr_3 (.A0(rcount_6), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2_4), .S0(ircount_6), .S1(ircount_7)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(500[11] 502[67])
    ...
    CCU2C af_cmp_ci_a (.A0(scuba_vhi), .B0(scuba_vhi), .C0(scuba_vhi), 
          .D0(scuba_vhi), .A1(scuba_vhi), .B1(scuba_vhi), .C1(scuba_vhi), 
          .D1(scuba_vhi), .COUT(cmp_ci_2)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(508[11] 510[47])
    ...
    CCU2C af_cmp_0 (.A0(fcount_0), .B0(fcnt_en_inv_inv), .C0(scuba_vhi), 
          ...
          .D1(scuba_vhi), .CIN(cmp_ci_2), .COUT(co0_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(516[11] 518[52])
    ...
    CCU2C af_cmp_1 (.A0(fcount_2), .B0(cnt_con_inv), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co0_5), .COUT(co1_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(524[11] 526[49])
    ...
    CCU2C af_cmp_2 (.A0(fcount_4), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co1_5), .COUT(co2_5)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(532[11] 534[49])
    ...
    CCU2C af_cmp_3 (.A0(fcount_6), .B0(scuba_vhi), .C0(scuba_vhi), .D0(scuba_vhi), 
          ...
          .CIN(co2_5), .COUT(af_d_c)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(540[11] 542[50])
    ...
    CCU2C a2 (.A0(scuba_vlo), .B0(scuba_vlo), .C0(scuba_vhi), .D0(scuba_vhi), 
          .A1(scuba_vlo), .B1(scuba_vlo), .C1(scuba_vhi), .D1(scuba_vhi), 
          .CIN(af_d_c), .S0(af_d)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(552[11] 554[49])
    ...
    AND2 AND2_t2 (.A(wren_i), .B(rden_i_inv), .Z(cnt_con)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(130[10:59])
    XOR2 XOR2_t1 (.A(wren_i), .B(rden_i), .Z(fcnt_en)) /* synthesis syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(132[10:55])
    ...
    FD1P3DX FF_26 (.D(ifcount_0), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
            .Q(fcount_0)) /* synthesis GSR="ENABLED", syn_instantiated=1 */ ;   // f:/cypress_prj/hdmi_rx_cypress/hdmi_industrial_4k_init1/aud_buf/aud_buffer/aud_buffer.v(199[13] 200[22])
