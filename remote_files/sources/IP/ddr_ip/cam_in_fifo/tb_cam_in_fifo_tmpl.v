...
module tb;
    ...
    cam_in_fifo u1 (.Data(Data), .WrClock(WrClock), .RdClock(RdClock), .WrEn(WrEn), 
        .RdEn(RdEn), .Reset(Reset), .RPReset(RPReset), .Q(Q), .RCNT(RCNT), 
    ...
    begin
      ...
      @(WrEn == 1'b1);
      @(WrEn == 1'b0);
      for (i5 = 0; i5 < 1027; i5 = i5 + 1) begin
        @(posedge RdClock);
        #1  RdEn <= 1'b1;
      end
       RdEn <= 1'b0;
