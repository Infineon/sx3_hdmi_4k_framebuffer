...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n cam_in_fifo -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 2048 -width 32 -rwidth 64 -regout -no_enable -sync_reset -pe -1 -pf -1 -rfill -fdc F:/cypress_prj/HDMI_Rx_cypress/hdmi_Industrial_4k_audio_check_2/ddr_ip/cam_in_fifo/cam_in_fifo.fdc  */
/* Fri Mar 12 11:17:25 2021 */


`timescale 1 ns / 1 ps
module cam_in_fifo (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, 
    Q, RCNT, Empty, Full)/* synthesis NGD_DRC_MASK=1 */;
    ...
    ROM16X1A LUT4_27 (.AD3(w_gcount_r20), .AD2(w_gcount_r21), .AD1(w_gcount_r22), 
        .AD0(w_gcount_r23), .DO0(w_g2b_xor_cluster_2));

    defparam LUT4_26.initval =  16'h6996 ;
    ROM16X1A LUT4_26 (.AD3(w_gcount_r210), .AD2(w_gcount_r211), .AD1(scuba_vlo), 
        .AD0(scuba_vlo), .DO0(wcount_r10));

    defparam LUT4_25.initval =  16'h6996 ;
    ROM16X1A LUT4_25 (.AD3(w_gcount_r29), .AD2(w_gcount_r210), .AD1(w_gcount_r211), 
    ...
    ROM16X1A LUT4_18 (.AD3(w_gcount_r21), .AD2(w_gcount_r22), .AD1(w_gcount_r23), 
        .AD0(scuba_vlo), .DO0(w_g2b_xor_cluster_2_1));

    defparam LUT4_17.initval =  16'h6996 ;
    ROM16X1A LUT4_17 (.AD3(w_g2b_xor_cluster_0), .AD2(w_g2b_xor_cluster_1), 
    ...
    XOR2 XOR2_t0 (.A(w_gcount_r211), .B(rptr_10), .Z(rfill_sub_msb));

    defparam LUT4_3.initval =  16'h0410 ;
    ROM16X1A LUT4_3 (.AD3(rptr_10), .AD2(rcount_10), .AD1(w_gcount_r211), 
        .AD0(scuba_vlo), .DO0(empty_cmp_set));

    defparam LUT4_2.initval =  16'h1004 ;
    ROM16X1A LUT4_2 (.AD3(rptr_10), .AD2(rcount_10), .AD1(w_gcount_r211), 
        .AD0(scuba_vlo), .DO0(empty_cmp_clr));

    defparam LUT4_1.initval =  16'h0140 ;
    ROM16X1A LUT4_1 (.AD3(wptr_11), .AD2(wcount_11), .AD1(r_gcount_w210), 
        .AD0(scuba_vlo), .DO0(full_cmp_set));

    defparam LUT4_0.initval =  16'h4001 ;
    ROM16X1A LUT4_0 (.AD3(wptr_11), .AD2(wcount_11), .AD1(r_gcount_w210), 
    ...
    DP16KD pdp_ram_0_0_3 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DOA6(), .DOA5(), .DOA4(), .DOA3(), .DOA2(), .DOA1(), .DOA0(), .DOB17(Q[40]), 
        .DOB16(Q[39]), .DOB15(Q[38]), .DOB14(Q[37]), .DOB13(Q[36]), .DOB12(Q[35]), 
        .DOB11(Q[34]), .DOB10(Q[33]), .DOB9(Q[32]), .DOB8(Q[8]), .DOB7(Q[7]), 
    ...
    DP16KD pdp_ram_0_1_2 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .CSB0(scuba_vlo), .RSTB(Reset), .DOA17(), .DOA16(), .DOA15(), .DOA14(), 
        .DOA13(), .DOA12(), .DOA11(), .DOA10(), .DOA9(), .DOA8(), .DOA7(), 
        .DOA6(), .DOA5(), .DOA4(), .DOA3(), .DOA2(), .DOA1(), .DOA0(), .DOB17(Q[49]), 
        .DOB16(Q[48]), .DOB15(Q[47]), .DOB14(Q[46]), .DOB13(Q[45]), .DOB12(Q[44]), 
        .DOB11(Q[43]), .DOB10(Q[42]), .DOB9(Q[41]), .DOB8(Q[17]), .DOB7(Q[16]), 
    ...
    DP16KD pdp_ram_0_2_1 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .CSB0(scuba_vlo), .RSTB(Reset), .DOA17(), .DOA16(), .DOA15(), .DOA14(), 
        .DOA13(), .DOA12(), .DOA11(), .DOA10(), .DOA9(), .DOA8(), .DOA7(), 
        .DOA6(), .DOA5(), .DOA4(), .DOA3(), .DOA2(), .DOA1(), .DOA0(), .DOB17(Q[58]), 
        .DOB16(Q[57]), .DOB15(Q[56]), .DOB14(Q[55]), .DOB13(Q[54]), .DOB12(Q[53]), 
        .DOB11(Q[52]), .DOB10(Q[51]), .DOB9(Q[50]), .DOB8(Q[26]), .DOB7(Q[25]), 
    ...
    DP16KD pdp_ram_0_3_0 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DOB16(), .DOB15(), .DOB14(), .DOB13(Q[63]), .DOB12(Q[62]), .DOB11(Q[61]), 
        .DOB10(Q[60]), .DOB9(Q[59]), .DOB8(), .DOB7(), .DOB6(), .DOB5(), 
    ...
    FD1P3DX FF_115 (.D(w_gdata_0), .SP(wren_i), .CK(WrClock), .CD(Reset), 
        .Q(w_gcount_0))
             /* synthesis GSR="ENABLED" */;
    ...
    FD1P3DX FF_69 (.D(rcount_0), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_0))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_68 (.D(rcount_1), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_1))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_67 (.D(rcount_2), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_2))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_66 (.D(rcount_3), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_3))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_65 (.D(rcount_4), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_64 (.D(rcount_5), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_63 (.D(rcount_6), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_62 (.D(rcount_7), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_61 (.D(rcount_8), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_60 (.D(rcount_9), .SP(rden_i), .CK(RdClock), .CD(rRst), .Q(rptr_9))
             /* synthesis GSR="ENABLED" */;
    ...
    FD1S3DX FF_58 (.D(w_gcount_0), .CK(RdClock), .CD(Reset), .Q(w_gcount_r0))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_57 (.D(w_gcount_1), .CK(RdClock), .CD(Reset), .Q(w_gcount_r1))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_56 (.D(w_gcount_2), .CK(RdClock), .CD(Reset), .Q(w_gcount_r2))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_55 (.D(w_gcount_3), .CK(RdClock), .CD(Reset), .Q(w_gcount_r3))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_54 (.D(w_gcount_4), .CK(RdClock), .CD(Reset), .Q(w_gcount_r4))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_53 (.D(w_gcount_5), .CK(RdClock), .CD(Reset), .Q(w_gcount_r5))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_52 (.D(w_gcount_6), .CK(RdClock), .CD(Reset), .Q(w_gcount_r6))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_51 (.D(w_gcount_7), .CK(RdClock), .CD(Reset), .Q(w_gcount_r7))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_50 (.D(w_gcount_8), .CK(RdClock), .CD(Reset), .Q(w_gcount_r8))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_49 (.D(w_gcount_9), .CK(RdClock), .CD(Reset), .Q(w_gcount_r9))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_48 (.D(w_gcount_10), .CK(RdClock), .CD(Reset), .Q(w_gcount_r10))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_47 (.D(w_gcount_11), .CK(RdClock), .CD(Reset), .Q(w_gcount_r11))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_46 (.D(r_gcount_0), .CK(WrClock), .CD(rRst), .Q(r_gcount_w0))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_45 (.D(r_gcount_1), .CK(WrClock), .CD(rRst), .Q(r_gcount_w1))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_44 (.D(r_gcount_2), .CK(WrClock), .CD(rRst), .Q(r_gcount_w2))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_43 (.D(r_gcount_3), .CK(WrClock), .CD(rRst), .Q(r_gcount_w3))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_42 (.D(r_gcount_4), .CK(WrClock), .CD(rRst), .Q(r_gcount_w4))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_41 (.D(r_gcount_5), .CK(WrClock), .CD(rRst), .Q(r_gcount_w5))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_40 (.D(r_gcount_6), .CK(WrClock), .CD(rRst), .Q(r_gcount_w6))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_39 (.D(r_gcount_7), .CK(WrClock), .CD(rRst), .Q(r_gcount_w7))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_38 (.D(r_gcount_8), .CK(WrClock), .CD(rRst), .Q(r_gcount_w8))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_37 (.D(r_gcount_9), .CK(WrClock), .CD(rRst), .Q(r_gcount_w9))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_36 (.D(r_gcount_10), .CK(WrClock), .CD(rRst), .Q(r_gcount_w10))
             /* synthesis GSR="ENABLED" */;
    ...
    FD1S3DX FF_27 (.D(w_gcount_r8), .CK(RdClock), .CD(Reset), .Q(w_gcount_r28))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_26 (.D(w_gcount_r9), .CK(RdClock), .CD(Reset), .Q(w_gcount_r29))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_25 (.D(w_gcount_r10), .CK(RdClock), .CD(Reset), .Q(w_gcount_r210))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_24 (.D(w_gcount_r11), .CK(RdClock), .CD(Reset), .Q(w_gcount_r211))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_23 (.D(r_gcount_w0), .CK(WrClock), .CD(rRst), .Q(r_gcount_w20))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_22 (.D(r_gcount_w1), .CK(WrClock), .CD(rRst), .Q(r_gcount_w21))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_21 (.D(r_gcount_w2), .CK(WrClock), .CD(rRst), .Q(r_gcount_w22))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_20 (.D(r_gcount_w3), .CK(WrClock), .CD(rRst), .Q(r_gcount_w23))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_19 (.D(r_gcount_w4), .CK(WrClock), .CD(rRst), .Q(r_gcount_w24))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_18 (.D(r_gcount_w5), .CK(WrClock), .CD(rRst), .Q(r_gcount_w25))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_17 (.D(r_gcount_w6), .CK(WrClock), .CD(rRst), .Q(r_gcount_w26))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_16 (.D(r_gcount_w7), .CK(WrClock), .CD(rRst), .Q(r_gcount_w27))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_15 (.D(r_gcount_w8), .CK(WrClock), .CD(rRst), .Q(r_gcount_w28))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_14 (.D(r_gcount_w9), .CK(WrClock), .CD(rRst), .Q(r_gcount_w29))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_13 (.D(r_gcount_w10), .CK(WrClock), .CD(rRst), .Q(r_gcount_w210))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_12 (.D(rfill_sub_0), .CK(RdClock), .CD(rRst), .Q(RCNT[0]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_11 (.D(rfill_sub_1), .CK(RdClock), .CD(rRst), .Q(RCNT[1]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_10 (.D(rfill_sub_2), .CK(RdClock), .CD(rRst), .Q(RCNT[2]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_9 (.D(rfill_sub_3), .CK(RdClock), .CD(rRst), .Q(RCNT[3]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_8 (.D(rfill_sub_4), .CK(RdClock), .CD(rRst), .Q(RCNT[4]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_7 (.D(rfill_sub_5), .CK(RdClock), .CD(rRst), .Q(RCNT[5]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_6 (.D(rfill_sub_6), .CK(RdClock), .CD(rRst), .Q(RCNT[6]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_5 (.D(rfill_sub_7), .CK(RdClock), .CD(rRst), .Q(RCNT[7]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_4 (.D(rfill_sub_8), .CK(RdClock), .CD(rRst), .Q(RCNT[8]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_3 (.D(rfill_sub_9), .CK(RdClock), .CD(rRst), .Q(RCNT[9]))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_2 (.D(rfill_sub_10), .CK(RdClock), .CD(rRst), .Q(RCNT[10]))
             /* synthesis GSR="ENABLED" */;
    ...
    defparam precin_inst407.INIT1 =  16'h0000 ;
    defparam precin_inst407.INIT0 =  16'h0000 ;
    CCU2C precin_inst407 (.A0(scuba_vhi), .A1(scuba_vhi), .B0(scuba_vhi), 
    ...
    CCU2C rfill_4 (.A0(w_g2b_xor_cluster_0), .A1(wcount_r9), .B0(rptr_7), 
    ...
    CCU2C rfill_5 (.A0(wcount_r10), .A1(rfill_sub_msb), .B0(rptr_9), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C empty_cmp_3 (.A0(rcount_6), .A1(rcount_7), .B0(wcount_r7), .B1(w_g2b_xor_cluster_0), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C empty_cmp_4 (.A0(rcount_8), .A1(rcount_9), .B0(wcount_r9), .B1(wcount_r10), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C full_cmp_5 (.A0(wcount_10), .A1(full_cmp_set), .B0(rcount_w9), 
        .B1(full_cmp_clr), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
        .D1(scuba_vhi), .CIN(co4_4), .S0(), .S1(), .COUT(full_d_c));
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_3 MEM_LPC_FILE cam_in_fifo.lpc
    // exemplar attribute pdp_ram_0_0_3 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_2 MEM_LPC_FILE cam_in_fifo.lpc
    // exemplar attribute pdp_ram_0_1_2 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_2_1 MEM_LPC_FILE cam_in_fifo.lpc
    // exemplar attribute pdp_ram_0_2_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_3_0 MEM_LPC_FILE cam_in_fifo.lpc
