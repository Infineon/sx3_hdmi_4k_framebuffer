...
------------------------------------------------------------------------------
 ...
 pmi_family  "EC"|"XP"|"XP2"|"SC"|"SCM"|"ECP"|"ECP2"|"ECP2M"|"ECP3"|"ECP5U"|"XO"|"XO2"|"LPTM"  "EC"
------------------------------------------------------------------------------
...
*/
// fpga\verilog\pkg\versclibs\data\pmi\pmi_pll_fp.v 1.9 20-FEB-2014 15:16:32 FGAO2
...
module pmi_pll_fp
 #(parameter pmi_freq_clki = "100.0",
   ...
   parameter pmi_freq_clkok = "50.0",   // EC/XP/ECP/XO/ECP2/XP2/ECP3 only
   parameter pmi_family = "EC",
   parameter pmi_phase_adj = "0.0",   // in degrees, ex: "22.5", "45.0", "90.0" etc.
   parameter pmi_duty_cycle = "50.0", // in percentage; EC/XP/ECP/XO/ECP2/XP2/ECP3 only
   parameter pmi_clkfb_source = "CLKOP", // "CLKOS" supported only for ECP3
   parameter pmi_fdel = "off",     // ECP2/ECP2M Only
...
reg [63:0] pmi_freq_clki_reg1, pmi_freq_clkfb_reg1;
real pmi_freq_clkop_reg, pmi_freq_clkos_reg;
reg [63:0] pmi_freq_clkop_reg1, pmi_freq_clkos_reg1;
real pmi_freq_clkok_reg, pmi_phase_adj_reg;
reg [63:0] pmi_freq_clkok_reg1, pmi_phase_adj_reg1;
real pmi_duty_cycle_reg, pmi_fdel_val_reg;
reg [63:0] pmi_duty_cycle_reg1;
...
begin
   if (pmi_family == "SC" || pmi_family == "SCM" ||
       pmi_family == "XO2" || pmi_family == "ECP5U" || pmi_family == "ECP5UM")
   begin
