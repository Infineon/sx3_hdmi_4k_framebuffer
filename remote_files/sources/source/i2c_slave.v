...
parameter fpga_major_version = 8'h01;
parameter fpga_minor_version = 8'h06;
	 ...
	 begin
		if(!reset_n_i)begin
			...
			slave_addr <= 7'd0;
				...
				fpga_reg[10] <= 8'h00;	//	Control register
		end
		else begin
			fpga_reg[1] <= fpga_major_version;
			fpga_reg[2] <= fpga_minor_version;
...
//assign img_wt = {fpga_reg[3],fpga_reg[4]};
//assign img_ht = {fpga_reg[5],fpga_reg[6]};
